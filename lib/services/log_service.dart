...
class LogService extends ChangeNotifier {
  ...
  LogLevel _getLogLevel(String message) {
    ...
    } else if (upperMessage.contains('[INFO]') || upperMessage.contains('✅') || upperMessage.contains('🚀') || upperMessage.contains('📡') || upperMessage.contains('📨') || upperMessage.contains('📂') || upperMessage.contains('🔄') || upperMessage.contains('🔧') || upperMessage.contains('➕') || upperMessage.contains('📋') || upperMessage.contains('📖') || upperMessage.contains('🔍')) {
